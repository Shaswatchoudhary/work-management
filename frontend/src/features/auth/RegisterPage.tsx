            ...
            <>
              <div className="register-form-section">
                ...
                <form className="register-form" onSubmit={submit} noValidate>
                      ...
                      {ROLES.map((r) => {
                        ...
                        return (
                          <button
                            key={r}
                            type="button"
                            className={`register-role-btn${selected ? ` register-role-btn--${r}-selected` : ""}`}
                            onClick={() => setRole(r)}
                          >
                  ...
                  {/* Error */}
                  {err && (
                    <div role="alert" className="register-error">{err}</div>
                  )}
                      ...
                      <div key={r} className="register-demo-item">
                        <div className="register-demo-item__info">
                          <div className="register-demo-item__top">
                            <span className={`register-demo-item__role-badge register-demo-item__role-badge--${r}`}>
                              {ROLE_CONFIG[r].label}
                            </span>
                          ...
                          <div className="register-demo-item__meta">
                            ...
                            <span className="register-demo-item__pass-label">
                              pass: <strong>{acc.password}</strong>
                            </span>
